                            ...
                            <div class="tab-content pt-0">
                                ...
                                {{-- Personal Info --}}
                                    <div class="tab-pane fade show active" id="emp_profile">
                                        <form action="{{ route('register/user') }}" method="POST" id="emp_profile_form">
                                            @csrf
                                            <div class="card"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label class="col-form-label">Payment Method
                                                                    <span class="text-danger">*</span></label>
                                                    ...
                                                    <label for="col-form-label">Possible working days and hours
                                                        <span class="text-danger">*</span></label>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <label class="col-form-label">Choose Rest
                                                                days</label>
                                                    ...
                                                    <div class="display-on-toggle">
                                                        <label for="col-form-label">Possible working days and
                                ...
                                <div class="tab-pane fade" id="emp_salary">
                                    ...
                                    <!-- Fulltime Tab -->
                                        <div style="display: none;" id="fulltime">
                                            <form action="{{ route('register/user') }}" method="POST" id="fulltime_form">
                                                @csrf
                                                <div class="card"
                                                    style="border-top-left-radius: 0px; border-top-right-radius: 0px;">
                                                    <div class="card-body">
                                                            ...
                                                            <div class="col-sm-4" hidden>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="night_sunday_bon" disabled
                                                                            placeholder="00.00" value="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-4" hidden>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control" disabled
                                                                            name="holiday_bon" placeholder="00.00"
                                                                            value="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4" hidden>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="holiday_bon_minus" disabled
                                                                            placeholder="00.00" value="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4" hidden>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="timesupplement_night_sunday" disabled
                                                                            placeholder="00.00" value="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="submit-section d-flex justify-content-center">
                                                            ...
                                                            <button class="btn btn-primary submit-btn ml-2" type="submit"  onclick="submitFulltime()"><i
                                                                    class="las la-save"></i>
                                                                Save</button>
                                                        </div>
                                                    </div>
                                    ...
                                    <!-- Parttime Tab -->
                                        <div style="display: none;" id="parttime">
                                            <form action=" {{ route('register/user') }}" method="POST" id="parttime_form">
                                                @csrf
                                                <div class="card"
                                                    style="border-top-left-radius: 0px; border-top-right-radius: 0px;">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="submit-section d-flex justify-content-center">
                                                            ...
                                                            <button class="btn btn-primary submit-btn ml-2" type="submit" onclick="submitParttime()"><i
                                                                    class="las la-save"></i>
                                                                Save</button>
                                                        </div>
                                                    </div>
                                    ...
                                    <!-- Hourly Tab -->
                                        <div style="display: none;" id="hourly">
                                            <form action=" {{ route('register/user') }}" id="hourly_form" method="POST">
                                                @csrf
                                                <div class="card"
                                                    style="border-top-left-radius: 0px; border-top-right-radius: 0px;">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="submit-section d-flex justify-content-center">
                                                            ...
                                                            <button class="btn btn-primary submit-btn ml-2" type="submit" onclick="submitHourly()"><i
                                                                    class="las la-save"></i>
                                                                Save</button>
                                                        </div>
                                                    </div>
...
@section('script')
    <script>
        ...
        function tabclick() {
            ...
            if (selectedValue == "selectcard") {
                $('.select-border').css('border', '1px solid #ff0000');
                $('.errMsg').css("display", 'block');
                document.querySelector('.select-border').scrollIntoView({
                    behavior: 'smooth'
                });
            } else {
                $('.emp_salary').attr('data-toggle', 'tab');
                $('.select-border').css('border', 'none');
                $('.errMsg').css("display", 'none');
            }
        }
        ...
        document.ready(function(){
            submitFulltime = function(){
            document.getElementById("emp_profile_form").submit();
            document.getElementById("fulltime_form").submit();
            }
            submitParttime = function(){
                document.getElementById("emp_profile_form").submit();
                document.getElementById("parttime_form").submit();
            }
            submitHourly = function(){
                document.getElementById("emp_profile_form").submit();
                document.getElementById("hourly_form").submit();
            }
        });
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.prev-form-btn').on('click', function() {
