                            ...
                            <div class="row user-tabs">
                                <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                                    <ul class="nav nav-tabs nav-tabs-bottom ">
                                        ...
                                        <li class="nav-item"><a href="#emp_salary" data-toggle="tab" class="nav-link emp_salary">Salary Information</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4" hidden>
                                                        <div class="form-group">
                                                            <label>Gender <span class="text-danger">*</span></label>
                                                            <select class="select form-control" name="payment_type" style="width: 100%;" tabindex="-1" aria-hidden="true" id="gender" name="gender" required>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="salary_amount" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="monthly_surcharge" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="pension_insurance" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label class="col-form-label">Unemployment Insurance <small class="text-muted">
                                                                    ALV Abzug</small></label>
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">%</span>
                                                                </div>
                                                                <input type="text" class="form-control" name="unemployment_insurance" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="accident_insurance" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="uvg_grb" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label class="col-form-label">Pension Fund Insurance<small class="text-muted">
                                                                    Pensionkasse Abzug</small></label>
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">%</span>
                                                                </div>
                                                                <input type="text" class="form-control" name="pension_fund" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="medical_insurance" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="collective_labor" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="expenses" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label class="col-form-label">Telephone and Shipment<small class="text-muted">
                                                                    Telefon und Versandspesen</small></label>
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">CHF</span>
                                                                </div>
                                                                <input type="text" class="form-control" name="telephone_shipment" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label class="col-form-label">Mileage Compensation <small class="text-muted">
                                                                    Kilometerentschadingung</small></label>
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">CHF</span>
                                                                </div>
                                                                <input type="text" class="form-control" name="mileage_compensation" placeholder="Type your salary amount" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="submit-section d-flex justify-content-center">
                                                    <button type="button" class="btn btn-primary submit-btn mr-2 prev-form-btn"><i class="las la-arrow-left"></i> Back</button>

                                                    <button class="btn btn-primary submit-btn ml-2" type="submit"><i class="las la-save"></i> Save</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card" style="border-top-left-radius: 0px; border-top-right-radius: 0px;">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="00.00" name="hourly_salary" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label class="col-form-label">Night/Sunday Bonus <small class="text-muted">
                                                                    Nacht - Sonntagszulage</small></label>
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">CHF</span>
                                                                </div>
                                                                <input type="text" class="form-control" placeholder="00.00" name="night_sunday_bon" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="00.00" name="holiday_bon" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label class="col-form-label">Holiday Bonus minus<small class="text-muted">
                                                                    Ferienentschadigung minus</small></label>
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">CHF</span>
                                                                </div>
                                                                <input type="text" class="form-control" placeholder="00.00" name="holiday_bon_minus" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="00.00" name="timesupplement_night_sunday" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" disabled placeholder="00.00" name="monthly_surcharge" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" disabled placeholder="00.00" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="pension_insurance" placeholder="00.00" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="00.00" name="unemployment_insurance" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="00.00" name="accident_insurance" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="uvg_grb" placeholder="00.00" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="pension_fund" disabled placeholder="00.00" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="medical_insurance" placeholder="00.00" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="collective_labor" placeholder="00.00" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="expenses" disabled placeholder="00.00" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="telephone_shipment" placeholder="00.00" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="mileage_compensation" placeholder="00.00" value="00.00">
                                                            </div>
                                                        </div>
                                                    </div>
