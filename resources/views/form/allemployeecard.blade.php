                ...
                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3 employeeclass">
                    <div class="card" style="height: 83%;">
                        <div class="card-body d-flex align-items-center justify-content-center">
                            ...
                            <a href="#" class="btn text-muted stretched-link" data-toggle="modal" data-target="#add_employee" style="border: none;"><i class="fa fa-3x fa-plus"></i> <br> Add Employee </a>
                            ...
                            <div class="row user-tabs">
                                <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                                    <ul class="nav nav-tabs nav-tabs-bottom ">
                                        ...
                                        <li class="nav-item"><a href="#emp_salary" data-toggle="tab" class="nav-link">Salary Information</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    placeholder="00.00" name="hourly_salary"
                                                                    value="{{ $hourlyConfig->hourly_salary }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    placeholder="00.00" name="holiday_bon"
                                                                    value="{{ $hourlyConfig->holiday_bon }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $hourlyConfig->pension_insurance }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $hourlyConfig->pension_fund }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $hourlyConfig->medical_insurance }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $hourlyConfig->collective_labor }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $hourlyConfig->telephone_shipment }}">
                                                            </div>
                                                        </div>
                                                    </div>
