                                        ...
                                        <div class="container-fluid">
                                            <div class="fixedcenter">
                                                    ...
                                                    <div class="userinput">
                                                        <form action="" method="get" accept-charset="utf-8" class="ui form">
                                                            ...
                                                            <div class="inline field">
                                                                <input id="rfid" class="enter_idno uppercase" name="idno " value="" type="text" placeholder="Enter your ID" required autofocus>
                        
                                                                <button id="btnclockin" type="button" class="ui positive large icon button">Enter</button>
                                                ...
                                                <div class="message-after">
                                                    <p>
                                                        <span id="greetings">Hey there</span>
