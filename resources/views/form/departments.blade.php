...
@section('content')
                            ...
                            <tbody>
                                @foreach ($departments as $key => $department)
                                    <tr>
                                        ...
                                        <td>{{ ++$key }}</td>
                                        {{-- <td>1</td> --}}
                                        <td class="departmentName">{{ $department->department }}</td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown"
                                                    aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item departmentUpdate" href="#" data-toggle="modal"
                                                        data_id="'.$department->id.'" data-target="#edit_department"><i
                                                            class="fa fa-pencil m-r-5"></i>
                                                        Edit</a>
                                                    <a class="dropdown-item departmentDelete" href="#" data-toggle="modal"
                    ...
                    <div class="modal-body">
                        <form action="{{ route('form/department/update') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <label>Department Name <span class="text-danger">*</span></label>
                                <input class="form-control" value="" type="text" id="department_edit" name="department">
                            </div>
                            <div class="submit-section">
    ...
    <script>
        $(document).on('click', '.departmentUpdate', function() {
            ...
            $('#department_edit').val(_this.find('.departmentName').text());
        });
    </script>
    {{-- delete model --}}
