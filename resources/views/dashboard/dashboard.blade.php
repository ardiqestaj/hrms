    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">Welcome <span class="">{{ Auth::user()->name }}</span>!</h3>
                        <ul class="breadcrumb">
            ...
            <div class="row">
                    ...
                    <div class="card dash-widget card-box1">
                        <div class="card-body"> <span class="dash-widget-icon"><i class="fa fa-user"></i></span>
                            <div class="dash-widget-info">
                                <h3>{{ $employeesCount->count() }}</h3> <span class="text-md">Employees</span>
                                <a href="{{ route('all/employee/card') }}" class="stretched-link"></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="card dash-widget card-box2">
                        <div class="card-body "> <span class="dash-widget-icon"><i class="fa fa-usd"></i></span>
                            <div class="dash-widget-info">
                                <h3>{{ $clientsCount->count() }}</h3> <span class="">Clients</span>
                                <a href="{{ route('clients/clients') }}" class="stretched-link"></a>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="card dash-widget card-box3">
                        <div class="card-body"> <span class="dash-widget-icon"><i class="la la-map-marked-alt"></i></span>
                            <div class="dash-widget-info">
                                <h3>{{ $locations->count() }}</h3> <span class="">Locations</span>
                                <a href="{{ route('location/locations') }}" class="stretched-link"></a>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="card dash-widget card-box4">
                        <div class="card-body"> <span class="dash-widget-icon"><i class="las la-calendar-day"></i></span>
                            <div class="dash-widget-info">
                                @php
                                    use Carbon\Carbon;
                                ...
                                @foreach ($checkHolidays as $checkHoliday)
                                    @if ($today_date == $checkHoliday->start)
                                        <h4> {{ $today_date = date('F j, Y') }} <br>
                                            <br>
                                        </h4>
                                        <span class="">Happy {{ $checkHoliday->title }} Day <i class="las la-glass-cheers"></i></span>
                                ...
                                @if ($today != 1)
                                    ...
                                    @endif
                                @endif
                                <a href="{{ route('form/holidays/new') }}" class="stretched-link"></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            ...
                                                            <a href="{{ url('clients/client-profile/' . $client->client_id) }}">{{ $client->client_name }}
                                                                </span></a>
                                                        </h2>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown action-label">
                                                            ...
                                                            @if ($employee->status == 'Active')
                                                                <a class="btn btn-white btn-sm btn-rounded" aria-expanded="false" style="cursor: default">
