                            ...
                            <div class="modal-body text-center">
                                <form method="POST" enctype="multipart/form-data" id="save-content-form" action="{{ route('posts/edit') }}">
                                    ...
                                    <div class="mb-3 text-left">
                                        ...
                                        <input value="{{ $posts->title }}" type="text" class="form-control" name="title" placeholder="Title" required>
                                    ...
                                    <div class="mb-3 text-left">
                                        ...
                                        <input value="{{ $posts->description }}" type="text" class="form-control" name="description" placeholder="Description" required>
                                    ...
                                    <div class="mb-3 text-left">
                                        ...
                                        <input value="{{ $posts->image }}" type="file" class="form-control" id="image" name="image" placeholder="image">
                                    ...
                                    <div class="mb-3 text-left">
                                        ...
                                        <textarea class="form-control" id="tinymce" name="body">{{ $posts->body }} </textarea>
