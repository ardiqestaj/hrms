...
@section('content')
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h3 class="page-title">TimeClock Settings</h3>
                            </div>
                        </div>
                    </div>
                        <!-- /Page Header -->
                        {{-- <div class="tab-content"> --}}
                               {{-- message --}}
                    {!! Toastr::message() !!}
                    <form action="{{ url('timeclock/update') }}" class="ui form" method="post" accept-charset="utf-8">
                        @csrf
                        {{-- <div class="content"> --}}
                        {{-- ----Country------ --}}
                        <div class="form-group">
                            <label for="country">Country</label>
                            <select name="country" class="ui search dropdown uppercase form-control bg-transparent" id="country">
                        ...
                        <div class="form-group">
                            ...
                            <select name="timezone" class="ui search dropdown uppercase bg-transparent" id="timezone">
                        ...
                        <div class="form-group">
                            ...
                            <select name="time_format" class="ui dropdown uppercase bg-transparent" id="timeformat">
                        ...
                        {{-- ----Time In comments------ --}}
                        <label class="d-block">Comments (Turn on to require comments when clocking in)</label>
                        <div class="ui toggle checkbox mb-3">
                            <input type="checkbox" class="bg-transparent" name="clock_comment" @isset($data->clock_comment)@if($data->clock_comment == "on") checked @endif @endisset>
                            <label>Toggle Off/On</label>
                        </div>

                        {{-- ----RFID Clock In and Clock Out------ --}}
                        {{-- <hr> --}}
                        <label class="d-block">IP restriction</label>
                        <div class="ui toggle checkbox">
                            <input type="checkbox" class="bg-transparent checkbox-btn" name="rfid" @isset($data->rfid)@if($data->rfid == "on") checked @endif @endisset>
                            <label>Toggle Off/On</label>
                        </div>
                    
                        {{-- ----Web clock IP restriction------ --}}
                        <div id="textarea-ch" style="transition: all .3s">
                            <small class="d-block mt-2">Enter below the Public IP Addresses you give permission to ClockIn/ClockOut</small>
                            <textarea name="iprestriction"  class="bg-transparent" rows="3" placeholder="{{ __("Enter IP addresses, if more than one add comma after each IP address")}}">@isset($data->iprestriction){{ $data->iprestriction }}@endisset</textarea>
                        </div>
                        {{-- </div> --}}
                        
                        <div class="actions submit-section">
                            <button type="submit"  name="submit" class="btn btn-primary submit-btn approve positive">Save</button>
                        </div>
                    </form> 
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(function()
        {
            if ($('.checkbox-btn').is(':checked')) {
                document.getElementById( 'textarea-ch' ).style.display = 'block';
            }
            else{
                document.getElementById( 'textarea-ch' ).style.display = 'none';
            }
